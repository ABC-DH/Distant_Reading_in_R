...
# try other sentences!
my_sentence <- "..."
get_sentiment(my_sentence, method="...")
...
text_annotated_sentiart1 <- left_join(text_annotated, sentiart, by = c("token_lower" = "word")) 
View(text_annotated_sentiart1)
...
text_annotated_sentiart2 <- left_join(text_annotated, sentiart, by = c("token_lower" = "word")) 
View(text_annotated_sentiart2)
